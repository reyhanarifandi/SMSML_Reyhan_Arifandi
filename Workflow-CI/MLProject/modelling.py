...
# HAPUS set_experiment agar tidak konflik dengan GitHub Actions
...
def train():
    ...
    # Kita HAPUS blok 'with mlflow.start_run(...):' 
    # Karena 'mlflow run' di GitHub Actions SUDAH otomatis membuat Run aktif.
    # Kita langsung eksekusi kodenya saja, MLflow akan otomatis mencatat ke Run yang aktif.
    ...
    # 5. Log ke MLflow
    # Perintah log ini otomatis masuk ke 'Run' yang dibuat oleh GitHub Actions
